				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 1007 E 24th St?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 1007 E 24th St</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>538 E 20th St</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1,733 Sq Ft -  6,650 Lot</li>
											<li>List: 7/31/2013 - Sold: 8/30/13</li>
											<li>List: $449,000 - SOLD $478,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2601 9th Ave</strong></h3>
										<ul>
											<li>4 Bed - 3 Bath</li>
											<li>1,927 Sq Ft - 4,000 Lot</li>
											<li>List: 4/30/13 - Sold: 6/5/13</li>
											<li>List: $435,000 - SOLD $555,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>621 E 22nd St</strong></h3>
										<ul>
											<li>4 Bed - 3 Bath</li>
											<li>2,048 Sq Ft - 5,700 Lot</li>
											<li>List: 5/14/13 - Sold: 6/21/13</li>
											<li>List: $438,000 - SOLD $600,000</li>
										</ul>
									</article>
								</div>
							</div>
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=6ba2d5e9-51d1-41b0-a79a-3d97bb2f4d3e&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.png" /></a>
						</div>
					</section>
